<template>
  <v-card class="project-card mt-6" style="width: 100%">
    <v-card-title>
        ...
        <v-expansion-panel class="project-card" title="Environments">
          <template #text>
            <v-row class="w-100 d-flex justify-space-between" width="100">
              <v-col v-for="env of project.environments" :key="env.environmentKey">
    ...
    <v-card-actions>
      <v-row>
        <v-col cols="6" class="d-flex justify-start">
          <v-row>
            <v-col cols="12" class="pa-0 ma-0 ml-4 mb-0 mt-2 project-actions-dates">
              <small class="mr-2">Created at</small>
              <small>{{ project.createdAt }}</small>
            </v-col>
            <v-col cols="12" class="pa-0 ma-0 ml-4 d-flex align-center mb-3 project-actions-dates">
